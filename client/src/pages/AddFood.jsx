...
export default function AddFood() {
  ...
  return (
    <div className="max-w-md md:max-w-2xl mx-auto min-h-screen px-4 py-8 pt-20 bg-[var(--bg-primary)] transition-colors duration-300">
      ...
      <div className="bg-[var(--bg-surface)] p-8 rounded-[3rem] shadow-2xl shadow-black/[0.03] border border-[var(--border-color)]">
        <form onSubmit={submit} className="space-y-6">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-[var(--brand-orange)] text-white h-16 rounded-[1.5rem] font-black flex items-center justify-center space-x-3 hover:shadow-2xl hover:shadow-orange-500/30 transition-all active:scale-95 disabled:opacity-50 mt-4 text-lg tracking-tight"
          >
